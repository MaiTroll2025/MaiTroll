        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <MentionTextarea
              value={content}
              onChange={setContent}
              placeholder={disabled ? disabledMessage : postType === 'video' ? "Describe your video..." : postType === 'image' ? "Describe your photo..." : "What's on your mind? Use # to tag users"}
              rows={4}
              maxLength={240}
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              type="submit"
              disabled={disabled || !content.trim() || loading || content.length > 240}
