...
const isLocalhost =
  ...
  const subscribeToPush = useCallback(async () => {
    ...
    try {
      ...
      console.log('[PWA] Notification.permission after request:', permission);
      ...
      try {
        ...
        console.error('[PWA] Service worker not ready:', swError);
        return;
      }
      ...
      console.log('[PWA] Push subscription endpoint:', subscription.endpoint);
      ...
      if (error) {
        console.error('[PWA] Supabase push subscription save error:', error);
      } else {
        console.log('[PWA] Supabase push subscription save success');
      }
  ...
  const unsubscribeFromPush = useCallback(async () => {
    ...
    try {
      ...
      try {
        ...
        console.error('[PWA] Service worker not ready for unsubscribe:', swError);
        return;
      }
