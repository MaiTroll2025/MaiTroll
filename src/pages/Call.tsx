  ...
  useEffect(() => {
    ...
    const connectCall = async () => {
      try {
        ...
        const existingParticipants = participantCollection instanceof Map
          ? Array.from(participantCollection.values())
          : Array.isArray(participantCollection)
            ? participantCollection
            : participantCollection && typeof participantCollection.values === 'function'
              ? Array.from(participantCollection.values())
              : [];
