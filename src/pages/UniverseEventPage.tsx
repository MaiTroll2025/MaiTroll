...
export default function UniverseEventPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-slate-50 to-white text-slate-900 pb-20 relative overflow-y-auto overflow-x-hidden md:overflow-hidden">
      {/* Background Effects */}
