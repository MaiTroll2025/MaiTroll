...
export const BROADCAST_CATEGORIES: Record<BroadcastCategoryId, BroadcastCategoryConfig> = {
  ...
  // 13. Battle - Universal Battle mode
  battle: {
    id: 'battle',
    name: '⚔️ Universal Battle',
    icon: '⚔️',
    description: 'Start a Universal Battle with team-based 1v1 to 5v5 format',
    layoutMode: 'grid',
    defaultBoxCount: 2,
    maxBoxCount: 5,
    allowGuestBoxes: true,
    allowAddBox: false, // Host cannot add/remove boxes - locked to battle format
    allowDeductBox: false, // Host cannot add/remove boxes - locked to battle format
    hostRoleLabel: 'Host',
    allowFrontCamera: true,
    allowRearCamera: true,
    forceRearCamera: false,
