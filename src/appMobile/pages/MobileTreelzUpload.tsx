...
const MAX_DURATION = 600 // seconds (10min)

export default function MobileTreelzUploadPage() {
    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-[#050715] px-6 text-center">
        ...
        <p className="mb-1 text-sm text-slate-400">
          Your Treelz uploads have been disabled.
        </p>
    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-[#050715] px-6 text-center">
        ...
        <div className="flex gap-3">
          ...
          <button
            onClick={() => { setUploadSuccess(false); setFile(null); setPreview(null); setCaption('') }}
        ...
        {banStatus && banStatus.strikes > 0 && (
          <div className="rounded-xl border border-yellow-500/20 bg-yellow-500/10 p-3">
            <p className="text-xs font-bold text-yellow-400">
              ⚠️ {banStatus.strikes} strike{banStatus.strikes > 1 ? 's' : ''} on record.
            </p>
            <p className="mt-1 text-[10px] text-yellow-400/70">
              3 strikes = 1 week upload ban. AI-generated content will be flagged for review.
            </p>
          </div>
        )}
      </div>
