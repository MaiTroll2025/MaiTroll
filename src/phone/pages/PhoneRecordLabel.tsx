  ...
  return (
    <div className="relative min-h-screen w-full bg-[#05010f] text-white">
      <header className="sticky top-0 z-40 flex items-center justify-between border-b border-[#00BFFF]/20 bg-[#05010f]/90 px-4 py-3 backdrop-blur-2xl">
        ...
        <h1 className={`text-sm font-black uppercase tracking-widest ${neonTextGradient}`}>Record Label</h1>
        <div className="w-9" />
      </header>
      <main className="p-4">
        <section className={`${neonCard} p-5 text-center`}>
          <Music className="mx-auto h-10 w-10 text-pink-400" />
          <h2 className="mt-3 text-lg font-black text-white">Mai Record Label</h2>
          <p className="mt-2 text-xs text-zinc-400">Discover artists, releases, and label news.</p>
        </section>
      </main>
    </div>
  )
