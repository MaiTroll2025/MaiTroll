  ...
  return (
    <div className="relative min-h-screen w-full bg-[#05010f] text-white">
      <header className="sticky top-0 z-40 flex items-center justify-between border-b border-[#00BFFF]/20 bg-[#05010f]/90 px-4 py-3 backdrop-blur-2xl">
        ...
        <h1 className={`text-sm font-black uppercase tracking-widest ${neonTextGradient}`}>Admin Mobile</h1>
        <div className="w-9" />
      </header>
      <main className="p-4">
        <section className={`${neonCard} p-5 text-center`}>
          <Smartphone className="mx-auto h-10 w-10 text-[#00BFFF]" />
          <h2 className="mt-3 text-lg font-black text-white">Admin Mobile</h2>
          <p className="mt-2 text-xs text-zinc-400">Mobile admin controls and quick actions.</p>
        </section>
      </main>
    </div>
  )
