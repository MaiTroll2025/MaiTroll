    ...
    <div className="relative min-h-screen w-full bg-[#05010f] text-white">
      ...
      <main className="p-4">
        <section className={`${neonCard} p-5 text-center`}>
          <Wallet className="mx-auto h-10 w-10 text-green-400" />
          <h2 className="mt-3 text-lg font-black text-white">Payouts</h2>
          <p className="mt-2 text-xs text-zinc-400">Review and manage payout requests.</p>
        </section>
      </main>
    </div>
  )
