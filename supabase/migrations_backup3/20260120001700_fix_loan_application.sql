-- Migration to update troll_bank_apply_for_loan to use strict tiered logic
-- Removes legacy checks (7-day age, 100 coin spend, gift received)
-- Enforces tiers: <1mo (100), <6mo (1000), >6mo (2000) based on bank_tiers table
...
BEGIN
    ...
    -- Default to 0 if no tier matches (shouldn't happen given 'New User' starts at 0)
