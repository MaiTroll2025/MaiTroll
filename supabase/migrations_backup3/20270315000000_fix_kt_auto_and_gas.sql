...
BEGIN
    ...
    -- 9. Update user profile to set vehicle_id (for neighborhood onboarding progression)
    UPDATE public.user_profiles
    SET vehicle_id = v_user_vehicle_id
    WHERE id = v_user_id;

    RETURN jsonb_build_object('success', true, 'message', 'Vehicle purchased', 'vehicle_id', v_user_vehicle_id);
