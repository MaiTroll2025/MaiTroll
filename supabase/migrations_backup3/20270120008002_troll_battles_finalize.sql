...
BEGIN
    ...
    VALUES (
        v_battle.player1_id, 
        v_week_start, 
        CASE WHEN v_winner_id = v_battle.player1_id THEN 1 ELSE 0 END,
        CASE WHEN v_winner_id = v_battle.player2_id THEN 1 ELSE 0 END,
        v_battle.player1_score
    )
