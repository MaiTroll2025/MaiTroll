-- Fix purchase_rgb_broadcast cost to match the UI (toast promises "-10 Coins").
-- Previous value of 500 caused "Insufficient funds" errors for most users when enabling RGB.
...
GRANT EXECUTE ON FUNCTION public.purchase_rgb_broadcast(UUID, BOOLEAN) TO authenticated;
GRANT EXECUTE ON FUNCTION public.purchase_rgb_broadcast(UUID, BOOLEAN) TO service_role;
