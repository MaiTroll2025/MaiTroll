...
CREATE INDEX IF NOT EXISTS idx_user_active_items_user_id ON user_active_items(user_id);
...
CREATE INDEX IF NOT EXISTS idx_user_avatar_customization_user_id ON user_avatar_customization(user_id);
...
CREATE INDEX IF NOT EXISTS idx_troll_mart_clothing_category ON troll_mart_clothing(category);
CREATE INDEX IF NOT EXISTS idx_troll_mart_clothing_is_active ON troll_mart_clothing(is_active);
...
CREATE INDEX IF NOT EXISTS idx_user_troll_mart_purchases_user_id ON user_troll_mart_purchases(user_id);
