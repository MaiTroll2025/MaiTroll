-- Secure Troll Bank Credit Functions
-- Adds app.bypass_coin_protection to credit functions and ensures proper ledger handling

-- 1. Secure troll_bank_credit_coins
-- This is the primary function for ADDING coins (purchases, gifts received, etc.)
