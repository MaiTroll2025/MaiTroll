...
-- ============================================================================
-- Re-creates the troll_feed tables that are missing from the schema cache.
...
CREATE TABLE IF NOT EXISTS public.troll_feed_settings (
  ...
  sleep_after_idle_ms bigint NOT NULL DEFAULT 300000,
  sleepy_after_idle_ms bigint NOT NULL DEFAULT 180000,
...
CREATE TABLE IF NOT EXISTS public.troll_feed_transactions (
  ...
  troll_allocation  integer NOT NULL,
