...
values
  ('president', 200, true, false, 'Elected President of Mai Troll'),
...
values
  ('president', 'Mr. President', 'Elected President of Mai Troll', 'community', 'mythic', 100)
...
begin
   ...
   -- Insert vote (trigger sets week_key)
   insert into president_votes (election_id, candidate_id, voter_id)
   values (p_election_id, p_candidate_id, v_voter_id);
