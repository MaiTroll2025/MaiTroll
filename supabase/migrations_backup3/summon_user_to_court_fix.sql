...
BEGIN
    ...
    -- CREATE COURT CASE
    -- =========================================================================
    -- Store users_involved as JSON array in text column for flexibility
    ...
    VALUES (
        ...
        p_reason,
        CASE 
            WHEN array_length(p_users_involved, 1) > 0 
            THEN array_to_json(p_users_involved)::text
            ELSE '[]'::text
        END
    )
...
-- When Mai Troll entities are fully ID-based, this function should be 
