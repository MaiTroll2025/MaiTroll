...
const supabaseUrl = Deno.env.get("MAITROLL_DB_URL") || Deno.env.get("SUPABASE_URL")!;
const supabaseServiceKey = Deno.env.get("MAITROLL_SERVICE_KEY") || Deno.env.get("SUPABASE_SERVICE_ROLE_KEY")!;
